                ...
                <div class="container">
                    ...
                    <?php 
                      ...
                      while ($cokluresimcek=$cokluresim->fetch(PDO::FETCH_ASSOC)) { ?>                                 
                                    ...
                                    <div class="lg-image">
                                        <img style="height: 550px !important" src="Admin/resimler/cokluresim/<?php echo $cokluresimcek['resim'] ?>" alt="product image">
                                    </div>
                    ...
                    <?php 
                      ...
                      while ($cokluresimcek=$cokluresim->fetch(PDO::FETCH_ASSOC)) { ?>                 
                                    ...
                                    <div class="sm-image"><img style="height: 100px !important" src="Admin/resimler/cokluresim/<?php echo $cokluresimcek['resim'] ?>" alt="product image thumb"></div>
                        ...
                        <div class="col-lg-7 col-md-6">
                            ...
                            <i style="color:green"> <?php if ($_GET['yuklenme']=="basarili") { ?>
                                Yorum başarıyla kayıt edildi </i>
                            ...
                            <div class="product-reviews">
                                <div class="product-details-comment-block">
                                    ...
                                    $kullanicilar=$baglanti->prepare("SELECT * FROM kullanici where kullanici_id=:kullanici_id");
                                        ...
                                        $kulanicilarcek=$kullanicilar->fetch(PDO::FETCH_ASSOC);


                                     ?>
                                    
                                    <div class="comment-author-infos pt-25">
                                        <span><?php echo $kulanicilarcek['kullanici_adsoyad']; ?></span>
                                ...
                                <?php } ?>
                                    ...
                                    <div class="review-btn">
                                        <a class="review-links" href="#" data-toggle="modal" data-target="#mymodal">Yorum Yap</a>
                                    </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <h3 class="review-page-title">YORUMUNUZU YAPINIZ</h3>
