...
<body style="background-color:#203239;" class="hold-transition login-page">
<div class="login-box">
  <div class="login-logo">
    <a style="color:white;" href="../../index2.html"><b style="color:white;">Mesha</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
        ...
        <div class="input-group mb-3">
          ...
          <div class="input-group-append">
            <div class="input-group-text">
              <span style="color:#203239" class="fas fa-envelope"></span>
            </div>
          </div>
        </div>
        <div class="input-group mb-3">
          ...
          <div class="input-group-append">
            <div class="input-group-text">
              <span style="color:#203239" class="fas fa-lock"></span>
            </div>
          </div>
        </div>
        <div class="row">
